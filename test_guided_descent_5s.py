#!/usr/bin/env python3
"""
Test 2: 5-Second 1 m/s Guided Descent & Auto-Release
====================================================
Purpose:
...
Usage Examples:
  ...
  python3 test_guided_descent_5s.py --connect /dev/ttyUSB0 --baud 115200 --release-mode AUTO
"""
...
def main():
    parser = argparse.ArgumentParser(description="Execute a 5-second 1 m/s descent test in GUIDED mode and release control.")
    ...
    print(f" - Handback Status   : Confirmed in {final_mode_name} (#{final_mode_num})")
    print("=" * 72)
